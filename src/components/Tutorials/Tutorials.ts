...
import TutorialsCardStyle from "./TutorialsCard.css"
import { appState, addObserver} from "../../store";
import { dispatch } from "../../store";
import { getPosts } from "../../store/actions";

class TutorialsCard extends HTMLElement {
    ...
    render() {
            ...
            css.innerHTML = TutorialsCardStyle;
...
customElements.define("tutorials-card", TutorialsCard);
